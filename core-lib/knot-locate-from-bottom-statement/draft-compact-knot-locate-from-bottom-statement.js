...
function KnotPointerBelongingsFromBottomStatement() {
    ...
    that.getPointerBelongingsFromFrontStatement = function () {
        ...
        pointerBelongingsFromFront.pointerBelongings = {
            pointerBelongingsAtTopLeft: knotPointerBelongingsFromBottomStatement.throughKnot.fromBottomStatement.pointerBelongingsAtTopLeft,
            pointerBelongingsAtBottomLeft: knotPointerBelongingsFromBottomStatement.throughKnot.fromBottomStatement.pointerBelongingsAtBottomLeft,
            pointerBelongingsAtBottomRight: knotPointerBelongingsFromBottomStatement.throughKnot.fromBottomStatement.pointerBelongingsAtBottomRight,
            pointerBelongingsAtRightTop: knotPointerBelongingsFromBottomStatement.throughKnot.fromBottomStatement.pointerBelongingsAtRightTop
        }
        // from-bottom
        ...
        knotFromBottomStatement.ctx.addEventListener('click', function (event) {
            ...
            if(knotFromBottomStatement.stickedAlbum.knotFrom('from-bottom-statement').at(1).getStatus() === 'passedThrough') {
                ...
                let knotFound = knotLocateStickd.locateFrom(
                    pointerBelongingsAtKnotLocateFromComputed.pointerBelongings.throughY,
                    pointerBelongingsAtKnotLocateFromComputed.pointerBelongings.throughX
                )
